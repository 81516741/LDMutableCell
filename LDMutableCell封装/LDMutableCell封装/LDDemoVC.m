...
-(void)group5{
    ...
    LDSettingItem * item = [LDSettingItem itemWithLeftImage:@"icon.jpg" leftMainTitle:@"牛不扭" leftDetailTitle:@"ld" cellType:LDSettingItemTypeSwitch valueKey:@"1" Operation:^{
        
    }];
    //2.左边图片、大标题  右边switch
    LDSettingItem * item1 = [LDSettingItem itemWithLeftImage:@"icon.jpg" leftMainTitle:@"牛不扭" leftDetailTitle:nil cellType:LDSettingItemTypeSwitch valueKey:@"2" Operation:^{
        
    }];
    //3.左边大标题  右边switch
    LDSettingItem * item2 = [LDSettingItem itemWithLeftImage:nil leftMainTitle:@"牛不扭" leftDetailTitle:nil cellType:LDSettingItemTypeSwitch valueKey:@"3" Operation:^{
